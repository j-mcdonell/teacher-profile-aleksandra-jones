      ...
      <Card className="bg-purple-950 text-white border-none shadow-xl">
        <CardContent className="p-8 md:p-12 space-y-6">
          ...
          <blockquote className="text-xl md:text-2xl font-serif leading-relaxed opacity-90">
            ...
            Her ability to increase reading levels by 150% in a single year stands as a testament to her approach."
          </blockquote>
          <div className="flex items-center gap-4 pt-4">
            ...
            <div>
              ...
              <div className="text-purple-200">Richard Henry Dana Middle School</div>
            </div>
          </div>
        </CardContent>
      </Card>
