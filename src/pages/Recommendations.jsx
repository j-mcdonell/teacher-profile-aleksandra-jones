      ...
      <Card className="bg-purple-950 text-white border-none shadow-xl">
        <CardContent className="p-8 md:p-12 space-y-6">
          ...
          <blockquote className="text-xl md:text-2xl font-serif leading-relaxed opacity-90">
            "Aleksandra is a rad good ass human. The kind of person who brings a light to your life that will leave an impact that radiates through your soul. You will be lucky to have known her."
          </blockquote>
