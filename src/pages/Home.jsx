    ...
    <div className="max-w-6xl mx-auto px-6 md:px-12 space-y-24 pb-24">
      ...
      <section className="flex flex-col-reverse md:flex-row items-center gap-12 mt-12 md:mt-24">
        <div className="flex-1 space-y-8 text-center md:text-left">
          <h1 className="text-4xl md:text-7xl font-extrabold tracking-tight text-slate-900 leading-tight">
            Hello, I'm <br /> <span className="text-purple-950">Aleksandra Jones</span>.
          </h1>
        ...
        <div className="flex-1 flex justify-center md:justify-end">
          <div className="relative w-72 h-72 md:w-[28rem] md:h-[28rem]">
            <div className="absolute inset-0 bg-purple-100 rounded-full blur-3xl opacity-60 animate-pulse"></div>
            <img 
              src="/profile-pic.JPG" // Ensuring this matches your file
              alt="Profile" 
      ...
      <section className="grid md:grid-cols-3 gap-8">
        <div className="p-8 bg-white rounded-3xl border border-slate-100 shadow-lg shadow-slate-100/50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
          <div className="w-12 h-12 bg-purple-50 rounded-2xl flex items-center justify-center text-purple-950 mb-6">
            ...
            <div className="bg-slate-50 border border-slate-100 p-8 rounded-3xl space-y-8">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary" className="px-3 py-1 text-sm bg-white border border-slate-200 hover:bg-white text-slate-700"><Waves className="w-3 h-3 mr-1"/> Surfing</Badge>
                  <Badge variant="secondary" className="px-3 py-1 text-sm bg-white border border-slate-200 hover:bg-white text-slate-700"><Mountain className="w-3 h-3 mr-1"/> Climbing</Badge>
                  <Badge variant="secondary" className="px-3 py-1 text-sm bg-white border border-slate-200 hover:bg-white text-slate-700"><PenTool className="w-3 h-3 mr-1"/> Writing</Badge>
                  <Badge variant="secondary" className="px-3 py-1 text-sm bg-white border border-slate-200 hover:bg-white text-slate-700"><ChefHat className="w-3 h-3 mr-1"/> Baking</Badge>
                </div>
              </div>
            </div>
          </div>
